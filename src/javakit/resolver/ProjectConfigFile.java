...
public class ProjectConfigFile {
     ...
     * Constructor.
     */
    public ProjectConfigFile(Project aProject, ProjectConfig aProjConfig)
    {
        _proj = aProject;
        _projConfig = aProjConfig;
    ...
    public WebFile getFile()
    {
        ...
        WebFile file = projSite.getFile(".classpath");
    ...
    public void getSourcePathRead()
    {
        ...
        WebSite projSite = _proj.getSite();
        if (path == null && projSite.getFile("/src") != null)
            path = "src";
